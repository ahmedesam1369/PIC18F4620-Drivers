...
/*  A/D Conversion Status bit : conversion in progress / A/D Idle*/
...
/* Analog /Digital Port Configuration Control bits */
#define ADC_ANALOG_DIGITAL_PORT_CONGIG(_CONFIG)   (ADCON1bits.PCFG = _CONFIG)
