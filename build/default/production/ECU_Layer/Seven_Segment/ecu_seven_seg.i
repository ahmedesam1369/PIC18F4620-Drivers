...
# 30 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) == seg )|| (((void*)0) == number ) || (number > 9) ){
        ret = (Std_ReturnType)0x00;
    }else{
