...
# 11 "MCAL_Layer/CCP/hal_ccp.h"
# 1 "MCAL_Layer/CCP/hal_cpp_cfg.h" 1
...
# 12 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h"
...
# 12 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h" 2

# 1 "MCAL_Layer/CCP/../Interrupt/../mcal_std_types.h" 1
# 12 "MCAL_Layer/CCP/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_Layer/CCP/../Interrupt/../std_libraries.h" 1
# 12 "MCAL_Layer/CCP/../Interrupt/../std_libraries.h"
...
# 12 "MCAL_Layer/CCP/../Interrupt/../std_libraries.h" 2
...
# 14 "MCAL_Layer/CCP/../Interrupt/../std_libraries.h" 2
...
# 12 "MCAL_Layer/CCP/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_Layer/CCP/../Interrupt/../compiler.h" 1
# 11 "MCAL_Layer/CCP/../Interrupt/../compiler.h"
...
# 11 "MCAL_Layer/CCP/../Interrupt/../compiler.h" 2
# 13 "MCAL_Layer/CCP/../Interrupt/../mcal_std_types.h" 2
# 30 "MCAL_Layer/CCP/../Interrupt/../mcal_std_types.h"
...
# 15 "MCAL_Layer/CCP/../Interrupt/../GPIO/hal_gpio.h"
...
# 38 "MCAL_Layer/CCP/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
Std_ReturnType CCP_CompareModeSetValue (const ccp_t *_ccp_obj, uint16 compare_value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    CCP_REG_T compare_temp_value = {.ccp_16Bit = 0 };
    if(((void*)0) == _ccp_obj){
        ret = (Std_ReturnType)0x00;
    }else{
...
static void CPP_CAPTURE_MOde_Config(const ccp_t *_ccp_obj){
    if(CCP1_INST == _ccp_obj->cpp_inst){
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8)0X04):
                (CCP1CONbits.CCP1M = ((uint8)0X04)); break;
            case ((uint8)0X05):
                (CCP1CONbits.CCP1M = ((uint8)0X05)); break;
            case ((uint8)0X06):
                (CCP1CONbits.CCP1M = ((uint8)0X06)); break;
            case ((uint8)0X07):
                (CCP1CONbits.CCP1M = ((uint8)0X07)); break;
             default: ;}
    }else if(CCP2_INST == _ccp_obj->cpp_inst){
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8)0X04):
                (CCP2CONbits.CCP2M = ((uint8)0X04)); break;
            case ((uint8)0X05):
                (CCP2CONbits.CCP2M = ((uint8)0X05)); break;
            case ((uint8)0X06):
                (CCP2CONbits.CCP2M = ((uint8)0X06)); break;
            case ((uint8)0X07):
                (CCP2CONbits.CCP2M = ((uint8)0X07)); break;
            default: ;}
    }else{ }
...
static void CPP_Compare_Mode_Config(const ccp_t *_ccp_obj){
    if(CCP1_INST == _ccp_obj->cpp_inst){
     switch(_ccp_obj->ccp_mode_variant){
        case ((uint8)0x08):
            (CCP1CONbits.CCP1M = ((uint8)0x08));break;
        case ((uint8)0x09):
            (CCP1CONbits.CCP1M = ((uint8)0x09)); break;
        case ((uint8)0x02):
            (CCP1CONbits.CCP1M = ((uint8)0x02));break;
        case ((uint8)0x0A):
            (CCP1CONbits.CCP1M = ((uint8)0x0A)); break;
        case ((uint8)0x0B):
            (CCP1CONbits.CCP1M = ((uint8)0x0B)); break;
        default:;}
    }else if(CCP2_INST == _ccp_obj->cpp_inst){
      switch(_ccp_obj->ccp_mode_variant){
        case ((uint8)0x08):
            (CCP2CONbits.CCP2M = ((uint8)0x08)); break;
        case ((uint8)0x09):
            (CCP2CONbits.CCP2M = ((uint8)0x09)); break;
        case ((uint8)0x02):
            (CCP2CONbits.CCP2M = ((uint8)0x02)); break;
        case ((uint8)0x0A):
            (CCP2CONbits.CCP2M = ((uint8)0x0A)); break;
        case ((uint8)0x0B):
            (CCP2CONbits.CCP2M = ((uint8)0x0B)); break;
        default: ;}
    }else{;}
    CCP_Mode_Timer_Select(_ccp_obj);
}
