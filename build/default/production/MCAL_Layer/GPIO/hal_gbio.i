...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/GPIO/hal_gbio.c" 2
...
# 7 "MCAL_Layer/GPIO/hal_gbio.c" 2


volatile uint8 *tris_registers[]= {0xF92, 0xF93, 0xF94, 0xF95, 0xF96};
volatile uint8 *lat_registers[]= {0xF89, 0xF8A, 0xF8B, 0xF8C, 0xF8D};
volatile uint8 *port_registers[]= {0xF80, 0xF81, 0xF82, 0xF83, 0xF84};
# 22 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *_pin_config)
{
...
# 107 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config, logic_t *logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 130 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *_pin_config){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _pin_config || _pin_config->pin > 8 -1){
        ret = (Std_ReturnType)0x00;
...
# 149 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_pin_initialize(const pin_config_t *_pin_config)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _pin_config || _pin_config->pin > 8 -1){
...
# 174 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port> 5 -1){
        ret = (Std_ReturnType)0x00;
...
# 193 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 213 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port> 5 -1)
    {
...
# 235 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 253 "MCAL_Layer/GPIO/hal_gbio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port> 5 -1){
        ret = (Std_ReturnType)0x00;
