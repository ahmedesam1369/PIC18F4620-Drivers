...
# 244 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 261 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
static Std_ReturnType NTERUPT_INTx_Disable(const interrupt_INTx_t *int_obj){
    ...
    if(((void*)0) == int_obj){
        ...
        switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0: (INTCONbits.INT0E = 0); ret = (Std_ReturnType)0x01; break;
            case INTERRUPT_EXTERNAL_INT1: (INTCON3bits.INT1E = 0); ret = (Std_ReturnType)0x01; break;
...
# 325 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_ReturnType NTERUPT_INTx_Edge_Init(const interrupt_INTx_t *int_obj){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) == int_obj){
        ret = (Std_ReturnType)0x00;
...
# 477 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
